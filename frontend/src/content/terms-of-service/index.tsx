      ...
      <Container maxWidth="lg" sx={{ mt: 8 }}>
        ...
        <Card sx={{ mx: { md: 10, xs: 1 }, padding: { xs: 2, md: 4 } }}>
          ...
          <Typography paragraph>
            ...
            the Maintenance Management System ("Company", "we", "us" or "our"),
            governing your use of the {brandConfig.name} software and services (the "Software").
          </Typography>
          ...
          <Typography paragraph>
            ...
            Company.{' '}
            Company owns all intellectual property rights to {brandConfig.name}, including
